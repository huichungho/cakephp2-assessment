<div class="row-fluid">
	...
	<table class="table table-bordered">
		...
		<tbody>
			<tr>
				<td>1</td>
				<td>Listing Record page too slow, try to optimize it. <b>[completed]</b> </td>
				<td>MH</td>
			...
			<tr>
				<td><?php echo __('2')?></td>
				<td><?php echo __('Change Display Format From Popup to Mouse over')?> <b>[completed]</b></td>
			...
			<tr>
				<td>3</td>
				<td>Advanced Input Field <b>[completed]</b></td>
				<td>XX</td>
			...
			<tr>
				<td>4</td>
				<td>Complete the File Upload feature <b>[completed]</b></td>
				<td>KC</td>
			...
			<tr>
				<td>5</td>
				<td>Multidimensional Array <b>[completed]</b></td>
				<td>YS</td>
			...
			<tr>
				<td><?php echo __('6')?></td>
				<td><?php echo __('Migration of data to multiple DB table')?> <b>[completed]</b></td>
				<td><?php echo __('HL')?></td>
				...
				<td><?php echo $this->Html->link('Click Me','/Member/add')?></td>
			</tr>
		</tbody>
	</table>
